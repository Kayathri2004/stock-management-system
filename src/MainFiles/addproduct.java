...
public class addproduct extends javax.swing.JFrame {
    ...
    try {
        ...
        // Check if the product with the same item_id already exists in the table
        String checkQuery = "SELECT * FROM inventory WHERE item_id = '" + item_id + "'";
        Statement smtCheck = con.createStatement();
        ResultSet rs = smtCheck.executeQuery(checkQuery);
        ...
        if (rs.next()) {
            ...
            String updateQuery = "UPDATE inventory SET quantity = " + newQuantity + " WHERE item_id = '" + item_id + "'";
            Statement smtUpdate = con.createStatement();
            int success = smtUpdate.executeUpdate(updateQuery);
            ...
            String insertQuery = "INSERT INTO inventory(item_id, item_name, quantity, price, mfd, exp, batchno) VALUES "
                    + "('" + item_id + "','" + item_name + "','" + quantity + "','" + price + "','" + mfd + "','" + exp + "','" + batchno + "')";
            Statement smtInsert = con.createStatement();
            int success = smtInsert.executeUpdate(insertQuery);
    ...
    try {
        ...
        // Check if the product with the same item_id, manufacturing date, and expiration date already exists in the table
        String checkQuery = "SELECT * FROM inventory WHERE item_id = '" + item_id + "' AND mfd = '" + mfd + "' AND exp = '" + exp + "'";
        Statement smtCheck = con.createStatement();
        ResultSet rs = smtCheck.executeQuery(checkQuery);

        if (rs.next()) {
            // If the product exists with the same item_id, manufacturing date, and expiration date, update the quantity
            int currentQuantity = rs.getInt("quantity");
            int newQuantity = Integer.parseInt(quantity) + currentQuantity;

            String updateQuery = "UPDATE inventory SET quantity = " + newQuantity + " WHERE item_id = '" + item_id + "' AND mfd = '" + mfd + "' AND exp = '" + exp + "'";
            Statement smtUpdate = con.createStatement();
            int success = smtUpdate.executeUpdate(updateQuery);
            ...
            // If the product doesn't exist with the same item_id, manufacturing date, and expiration date, insert a new entry
            String insertQuery = "INSERT INTO inventory(item_id, item_name, quantity, price, mfd, exp, batchno) VALUES "
                    + "('" + item_id + "','" + item_name + "','" + quantity + "','" + price + "','" + mfd + "','" + exp + "','" + batchno + "')";
            Statement smtInsert = con.createStatement();
            int success = smtInsert.executeUpdate(insertQuery);
